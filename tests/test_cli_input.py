...
def mock_prompt_session():
    ...
    with (
        patch("bao.cli.commands._PROMPT_SESSION", mock_session),
        patch("bao.cli.commands.patch_stdout"),
    ):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with (
        patch("bao.cli.commands.PromptSession") as MockSession,
        patch("bao.cli.commands.FileHistory"),
